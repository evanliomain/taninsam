 ...
 * Comparison between 2 elements is perform with an hash of the toKey(element) form.
 * @param toKey the function to transform array element into something that will be use to partition the array.
