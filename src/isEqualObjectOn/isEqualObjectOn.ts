 ...
 * @returns true if `o1[key] === o2[key]` for all key in mapping, false otherwise
 * @example
 * ```
 * isEqualObjectOn(['a', 'b'])({ a: 1, b: 2, c: 3 })({ a: 1, b: 2, c: 4 }) // true
 * isEqualObjectOn(['a', 'b', 'c'])({ a: 1, b: 2, c: 3 })({ a: 1, b: 2, c: 4 }) // false
 * ```
